...
PETSC_EXTERN PetscErrorCode DMPlexCreateFromCellList(MPI_Comm, PetscInt, PetscInt, PetscInt, PetscInt, PetscBool, const int[], PetscInt, const double[], PetscSF, DM*);
...
PETSC_EXTERN PetscErrorCode DMPlexConvertPartitionLabel(DM, DMLabel, ISLocalToGlobalMapping*, PetscSF*);
