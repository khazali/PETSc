...
PETSC_EXTERN PetscErrorCode DMPlexCreateSection(DM, PetscInt, PetscInt, const PetscInt [], const PetscInt [], DMLabel [], PetscInt, const PetscInt [], const IS [], const IS [], IS, PetscSection *);
