...
PETSC_EXTERN PetscErrorCode PetscQuadratureGetFieldDim(PetscQuadrature, PetscInt*);
PETSC_EXTERN PetscErrorCode PetscQuadratureSetFieldDim(PetscQuadrature, PetscInt);
