...
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_DEFAULT;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_MATLAB;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_IMPL;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_INFO;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_INFO_DETAIL;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_COMMON;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_INDEX;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_MATRIXMARKET;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_VTK;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_VTK_CELL;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_VTK_COORDS;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_PYTHON;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_LATEX;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_XML;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_ASCII_GLVIS;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_DRAW_BASIC;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_DRAW_LG;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_DRAW_CONTOUR;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_DRAW_PORTS;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_VTK_VTS;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_VTK_VTR;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_VTK_VTU;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_BINARY_MATLAB;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_NATIVE;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_NOFORMAT;
PETSC_EXTERN PetscViewerFormat PETSC_VIEWER_LOAD_BALANCE;

PETSC_EXTERN char *PetscViewerFormats[];
PETSC_EXTERN PetscViewerFormat PetscViewerFormatNumber;
PETSC_EXTERN PetscErrorCode PetscViewerFormatRegister(const char*,PetscViewerFormat*);
PETSC_EXTERN PetscErrorCode PetscViewerFormatGet(const char *,PetscViewerFormat*);
