...
PETSC_EXTERN PetscErrorCode  PCMinimalResidualSetBuckets(PC,PetscInt,PetscScalar*);
PETSC_EXTERN PetscErrorCode  PCMinimalResidualGetBuckets(PC,PetscInt*,const PetscScalar**);
