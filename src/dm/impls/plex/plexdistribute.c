...
#undef __FUNCT__
#define __FUNCT__ "DMPlexDistribute_Migrate"
PetscErrorCode DMPlexDistribute_Migrate(DM dm, PetscSection partSection, IS part, PetscSF pointSF, ISLocalToGlobalMapping renumbering, DM *dmParallel)
{
...
PetscErrorCode DMPlexDistribute_CreatePointSF(DM dm, PetscSF pointSF, PetscSection origPartSection, IS origPart, PetscSF *sf)
{
  ...
  ierr = PetscSFSetGraph(dm->sf, pEnd - pStart, numGhostPoints, ghostPoints, PETSC_OWN_POINTER, remotePoints, PETSC_OWN_POINTER);CHKERRQ(ierr);
