...
PETSC_EXTERN void PETSC_STDCALL dmplexcreatesection_(DM *dm, PetscInt *dim, PetscInt *numFields, F90Array1d *ptrC, F90Array1d *ptrD, F90Array1d *ptrL, PetscInt *numBC, F90Array1d *ptrF, F90Array1d *ptrCp, F90Array1d *ptrP, IS *perm, PetscSection *section, int *ierr PETSC_F90_2PTR_PROTO(ptrCd) PETSC_F90_2PTR_PROTO(ptrDd) PETSC_F90_2PTR_PROTO(ptrLd) PETSC_F90_2PTR_PROTO(ptrFd) PETSC_F90_2PTR_PROTO(ptrCpd) PETSC_F90_2PTR_PROTO(ptrPd))
{
  PetscInt *numComp;
  PetscInt *numDof;
  DMLabel  *label;
  ...
  *ierr = F90Array1dAccess(ptrL, MPIU_FORTRANADDR, (void**) &label PETSC_F90_2PTR_PARAM(ptrLd));if (*ierr) return;
  ...
  *ierr = DMPlexCreateSection(*dm, *dim, *numFields, numComp, numDof, label, *numBC, bcField, bcComps, bcPoints, *perm, section);
}
