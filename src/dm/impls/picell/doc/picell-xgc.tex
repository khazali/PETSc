...
This work leverages development work by the authors funded by the ASCR base program, the DOE FASTMath institute, and an Intel Parallel Processing Center (IPPC), which funds Dr. Tobin Issac.
Professor Matthew Knepley at Rice University (\$75,000 per year) and his student will work on the PETSc development and Dr. Mark Adams (\$75,000 per year) will hire a physicist and work with them on the X2 work.
The following tasks are proposed for this project by Professor Knepley's team [K] and Dr. Adams' team [A], with completion quarter unless otherwise stated.
\vskip .1cm 
\begin{itemize}
...
\end{itemize}
\vskip .1cm 
We intend to seek additional funding for a second year for the following work.
\vskip .1cm 
\begin{itemize}
