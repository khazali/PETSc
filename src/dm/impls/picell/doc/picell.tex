...
Figure \ref{fig:cross} (left) shows an example of half 64 a flux tube particle mesh and Figure \ref{fig:cross} (right) shows an example of (half) a coarse grid for ITER, colored with the condition number of the elements.
\begin{figure}[h!]
   \centering
