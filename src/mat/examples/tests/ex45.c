...
static void Store2DArray(int,int,double*,const char*,int*);
static void Store1DArray(int,double*,const char*,int*);
...
static void Store2DArray(int m,int n,double *a,const char *filename,int *fdd)
{
  int    fd = *fdd;
  int    i,j;
...
static void Store1DArray(int m,double *a,const char *filename,int *fdd)
{
  int fd      = *fdd;
