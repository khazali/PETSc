...
/*        find l = pivot index */
    ...
    if (a[l + k3] == (PetscReal)0) {
      if (shift == (PetscReal)0) SETERRQ1(PETSC_COMM_SELF,PETSC_ERR_MAT_LU_ZRPVT,"Zero pivot, row %D",k-1);
      else {
...
/*           row elimination with column indexing */
  ...
  ipvt[2] = 3;
  if (a[12] == (PetscReal)0) SETERRQ1(PETSC_COMM_SELF,PETSC_ERR_MAT_LU_ZRPVT,"Zero pivot, row %D",2);
