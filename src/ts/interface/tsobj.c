...
PetscErrorCode TSGetNumObjectives(TS ts, PetscInt *n)
{
  TSObj link = ts->funchead;
...
PetscErrorCode TSHasObjectiveIntegrand(TS ts, PetscBool *has, PetscBool *has_x, PetscBool *has_m, PetscBool *has_xx, PetscBool *has_xm, PetscBool *has_mm)
{
  TSObj link = ts->funchead;
...
PetscErrorCode TSHasObjectiveFixed(TS ts, PetscReal t0, PetscReal tf, PetscBool *has, PetscBool *has_x, PetscBool *has_m, PetscBool *has_xx, PetscBool *has_xm, PetscBool *has_mm, PetscReal *time)
{
  TSObj link = ts->funchead;
...
/*@C
   TSSetObjective - Sets a cost functional callback together with its gradient and Hessian terms.
