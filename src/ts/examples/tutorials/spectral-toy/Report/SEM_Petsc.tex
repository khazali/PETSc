...
%Consider a time dependent partial differential equation with constant coefficients, given by the spatial operator $ \mathcal P( u)$ and initial conditions $ g(\cdot)$ as
%\begin{eqnarray}
...
$$\mathcal{L}[ u,  u_0]=\int_{\Omega}( u[T]- u_d)^2 \ \d \Omega +\int_0^T\int_{\Omega} P[ u]  v \ \d \Omega \d t + \int_0^T\int_{\Gamma}  v_b  ( u-  u_b) \ \d \Gamma \d t$$
