...
Solve a toy problem using TSMULTI and the BFHMMFE algorithm from 
...
int main(int argc, char *argv[])
{
  ...
  ierr = TSMultiSetType(ts,TSMULTIBFHMMFE);CHKERRQ(ierr);
  ierr = TSMultiSetEpsilon(ts,epsilon);CHKERRQ(ierr);
