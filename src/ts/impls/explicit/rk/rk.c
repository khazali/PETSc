...
#define RC PetscRealConstant
  ...
  }
  {
    const PetscReal
      ...
      binterpt[7][5]={{1.,-4034104133/1410260304,105330401/33982176,-13107642775/11282082432,6542295/470086768},
                      {0.,0.,0.,0.,0.},
    ...
    ierr = TSRKRegister(TSRK5DP,5,7,&A[0][0],b,NULL,bembed,0,binterpt[0]);CHKERRQ(ierr);
  }
  {
    const PetscReal
