...
Implicit Runge-Kutta method using MatTAIJ.                          \n\
                                                                    \n\
...
PetscErrorCode ExactSolution(UserContext *ctx,DM dm,PetscReal t,Vec U)
{
  PetscErrorCode  ierr;
  PetscInt        i,j,k;
  DMDALocalInfo   info;
...
PetscErrorCode ComputeMatrix(DM da,Mat B,void *ctx)
{
  PetscErrorCode ierr;
