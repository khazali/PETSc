...
PetscMPIInt Petsc_ShmemComm_keyval = MPI_KEYVAL_INVALID;
...
PetscErrorCode  PetscInitialize(int *argc,char ***args,const char file[],const char help[])
{
  ...
  */
  ...
  ierr = MPI_Keyval_create(MPI_NULL_COPY_FN,Petsc_DelComm_Shmem,&Petsc_ShmemComm_keyval,(void*)0);CHKERRQ(ierr);
 ...
 */
  ...
  ierr = MPI_Keyval_free(&Petsc_ShmemComm_keyval);CHKERRQ(ierr);
