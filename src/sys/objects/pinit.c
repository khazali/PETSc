...
PetscErrorCode  PetscInitializeSAWs(const char help[])
{
  if (!PetscGlobalRank) {
    ...
    ierr = PetscSNPrintf(intro,introlen,"<body>\n"
                                    "<center><h2> <a href=\"http://www.mcs.anl.gov/petsc\">PETSc</a> (John O'Sullivan Edits) Application Web server powered by <a href=\"https://bitbucket.org/saws/saws\">SAWs</a> </h2></center>\n"
