...
New tests added to existing source files are automatically discovered by the testing system.
If you add tests to a new source file or rename a file that contains tests, run
\begin{bashlisting}
  make cleantest
\end{bashlisting}
before \texttt{test} or \texttt{print-test} targets.
