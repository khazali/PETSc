...
Davidon-Fletcher-Powell \cite{NW99}                & \lstinline|MATLMVMDFP|          & \trl{lmvmdfp}       & SPD \\
Broyden-Fletcher-Goldfarb-Shanno \cite{NW99}       & \lstinline|MATLMVMBFGS|         & \trl{lmvmbfgs}      & SPD \\
...
\begin{itemize}
  ...
  nonlinear updates and compute forward/inverse applications.
