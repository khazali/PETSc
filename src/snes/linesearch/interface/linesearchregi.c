...
PETSC_EXTERN PetscErrorCode SNESLineSearchCreate_BTSD(SNESLineSearch);
...
PetscErrorCode SNESLineSearchRegisterAll(void)
{
  ...
  ierr = SNESLineSearchRegister(SNESLINESEARCHBTSD,    SNESLineSearchCreate_BTSD);CHKERRQ(ierr);
