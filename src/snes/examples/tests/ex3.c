...
This example tests SNESSetKSPSetUpCallback().\n\n";
...
/*
    Allows program control over the sizes of each block in the block Jacobi preconditioner
*/
...
/*TEST
   ...
   test:
      args: -snes_monitor_short -snes_view
