...
/*TEST
  ...
  test:
    ...
    args: -run_type full -bc_type dirichlet -vel_petscspace_degree 3 -pres_petscspace_degree 2
  # Parallel tests 6-17
  test:
    suffix: 9
    requires: triangle
  ...
  test:
    ...
    requires: triangle
    args: -run_type full -sol_type cubic -bc_type dirichlet -cells 2,2 -dm_refine_hierarchy 1 \
      -vel_petscspace_degree 2 -pres_petscspace_degree 1 \
  ...
  test:
    ...
    args: -run_type full -bc_type dirichlet -simplex 0 -dm_refine 1 -vel_petscspace_degree 1 -pres_petscspace_degree 0 -petscds_jac_pre 0 \
  ...
  test:
    ...
    args: -run_type full -bc_type dirichlet -simplex 0 -dm_refine 0 -vel_petscspace_degree 2 -pres_petscspace_degree 1 -petscds_jac_pre 0 \
      -snes_rtol 1.0e-4 -snes_error_if_not_converged -snes_view -snes_monitor -snes_converged_reason \
  ...
  test:
    ...
    args: -run_type full -bc_type dirichlet -simplex 0 -dm_refine_hierarchy 3 -vel_petscspace_degree 1 -pres_petscspace_degree 0 -petscds_jac_pre 0 \
      -snes_rtol 1.0e-4 -snes_error_if_not_converged -snes_view -snes_monitor -snes_converged_reason \
