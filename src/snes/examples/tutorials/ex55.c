...
static PetscErrorCode Update_q(Vec,Vec,Vec,Vec,Mat,AppCtx*);
static PetscErrorCode Update_u(Vec,Vec,Vec,Vec);
...
static PetscErrorCode Update_u(Vec u1,Vec u2,Vec u3,Vec X)
{
  PetscErrorCode ierr;
  PetscInt       i,n;
...
static PetscErrorCode Update_q(Vec q,Vec u1,Vec u2,Vec u3,Mat M_0,AppCtx *user)
{
  PetscErrorCode ierr;
