...
/*TEST
  ...
  test:
    ...
    args: -sol_type elas_quad -simplex 0 -displacement_petscspace_degree 1 -dm_refine 2 -num_refine 3 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    requires: triangle
    args: -dim 3 -displacement_petscspace_degree 1 -dm_refine 1 -num_refine 3 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    requires: triangle
    args: -dim 3 -displacement_petscspace_degree 3 -dm_refine 1 -dmsnes_check
  test:
    suffix: 3d_q1_quad_vlap
    args: -dim 3 -simplex 0 -displacement_petscspace_degree 1 -dm_refine 1 -num_refine 3 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    args: -dim 3 -simplex 0 -displacement_petscspace_degree 3 -dm_refine 1 -dmsnes_check
  test:
    suffix: 3d_p1_quad_elas
    requires: triangle
    args: -sol_type elas_quad -dim 3 -displacement_petscspace_degree 1 -dm_refine 1 -num_refine 3 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    requires: triangle
    args: -sol_type elas_quad -dim 3 -displacement_petscspace_degree 3 -dm_refine 1 -dmsnes_check
  test:
    suffix: 3d_q1_quad_elas
    args: -sol_type elas_quad -dim 3 -simplex 0 -displacement_petscspace_degree 1 -dm_refine 1 -num_refine 3 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    args: -sol_type elas_quad -dim 3 -simplex 0 -displacement_petscspace_degree 3 -dm_refine 1 -dmsnes_check
  ...
  test:
    ...
    requires: triangle
    args: -sol_type vlap_trig -dim 3 -displacement_petscspace_degree 2 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_p3_trig_vlap
    requires: triangle
    args: -sol_type vlap_trig -dim 3 -displacement_petscspace_degree 3 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    args: -sol_type vlap_trig -dim 3 -simplex 0 -displacement_petscspace_degree 2 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_q3_trig_vlap
    args: -sol_type vlap_trig -dim 3 -simplex 0 -displacement_petscspace_degree 3 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
  ...
  test:
    ...
    requires: triangle
    args: -sol_type elas_trig -dim 3 -displacement_petscspace_degree 2 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_p3_trig_elas
    requires: triangle
    args: -sol_type elas_trig -dim 3 -displacement_petscspace_degree 3 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_q1_trig_elas
    args: -sol_type elas_trig -dim 3 -simplex 0 -displacement_petscspace_degree 1 -dm_refine 1 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_q2_trig_elas
    args: -sol_type elas_trig -dim 3 -simplex 0 -displacement_petscspace_degree 2 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
  test:
    suffix: 3d_q3_trig_elas
    args: -sol_type elas_trig -dim 3 -simplex 0 -displacement_petscspace_degree 3 -dm_refine 0 -num_refine 2 -snes_convergence_estimate
