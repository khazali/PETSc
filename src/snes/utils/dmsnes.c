...
.seealso: SNESConstraintSetAugFunctionJacobian(), DMSNESGetConstraintFunction(), SNESGetConstraintJacobian(), SNESConstraintAugFunction, SNESConstraintAugJacobian
@*/
